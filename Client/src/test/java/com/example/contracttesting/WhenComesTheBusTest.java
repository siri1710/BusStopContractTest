...
public class WhenComesTheBusTest {
    @Rule
    public PactProviderRuleMk2 provider = new PactProviderRuleMk2("BusService", "localhost", 8018, this);
    ...
    public RequestResponsePact createPact(PactDslWithProvider builder) {
        ...
        return builder
                .given("There is a bus with number 613 to Hammersmith bus station")
                .uponReceiving("A request for the eta  for the bus number 613 to Hammersmith bus station")
    ...
    public void doTest(){
        ...
        System.out.println("According to the Test ETA = "+eta);
        assertTrue(eta >= 0);
    }
}
